...
import { IDL, OfficeHouse } from '../target/types/office_house';
import { MetadataDataData, CreateMetadata } from '@metaplex-foundation/mpl-token-metadata';
...
describe('office-house', () => {
  ...
  // Clients.
  let authorityClient: Program<OfficeHouse>; // Represents the exchange authority.
  let sellerClient: Program<OfficeHouse>; // Represents the seller.
  let buyerClient: Program<OfficeHouse>; // Represents the buyer.
  ...
  it('Creates auction house program clients representing the buyer and seller', async () => {
    authorityClient = new Program<OfficeHouse>(
        IDL,
        AUCTION_HOUSE_PROGRAM_ID,
        getProvider(),
    );
    sellerClient = new Program<OfficeHouse>(
        IDL,
        AUCTION_HOUSE_PROGRAM_ID,
        new Provider(
            getProvider().connection,
    ...
    buyerClient = new Program<OfficeHouse>(
        IDL,
        AUCTION_HOUSE_PROGRAM_ID,
        new Provider(
            getProvider().connection,
  ...
  it('Creates an auction house', async () => {
    ...
    console.log('createOfficeHouse:', txSig);
  });
  ...
  it('Updates an auction house', async () => {
    ...
    console.log('updateOfficeHouse:', txSig);
